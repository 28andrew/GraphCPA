...
from graphCPA import GeneAutoencoder, RDKitMoleculeEncoder, DrugPerturbationEncoder, \
    CELL_TYPES
...
if __name__ == '__main__':
    ...
    ckpt = torch.load(f'./checkpoints/ckpt_epoch_{EPOCH_NUM}.pth', map_location=device)
    ...
    print('Done')
    df.to_csv(f'inference_{EPOCH_NUM}.csv', index=False)
