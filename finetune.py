...
import pandas as pd
import torch
from baseCPA import GeneDataset, GeneAutoencoder, RDKitMoleculeEncoder, DrugPerturbationEncoder, AdversarialClassifiers, \
    CELL_TYPES
...
def save_models(epoch, autoencoder, molecule_encoder, perturbation_encoder,
    ...
    torch.save(save_dict, f'checkpoints2/ckpt_epoch_{epoch}.pth')
...
def load_models(autoencoder, molecule_encoder, perturbation_encoder, adv_classifiers, device, optimizer):
    ckpts = glob.glob('checkpoints2/ckpt_epoch_*.pth')
